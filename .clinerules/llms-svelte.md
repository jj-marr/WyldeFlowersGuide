...
<div class="w-full space-y-4">
	<div class="grid grid-cols-3 gap-4">
		<button class="btn preset-gradient-one hover:brightness-125">Button</button>
		<button class="btn preset-gradient-two hover:brightness-125">Button</button>
		<button class="btn preset-gradient-three hover:brightness-125">Button</button>
	</div>
...
| `origin` | "start" | "center" | The origin of the slider range - "start": Useful when the value represents an absolute value - "center": Useful when the value represents an offset (relative) Default: "start" |
